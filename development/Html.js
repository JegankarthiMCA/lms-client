...
const localVideos = [
  {
    _id: '1',
    uri: require('../assets/videos/html.mp4'), // Adjust the path as needed
  },
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.htmlInfoContainer}>
        <Text style={styles.htmlTitle}>Introduction to HTML</Text>
        <Text style={styles.htmlDescription}>
        Hypertext Markup Language is the standard markup language for documents designed to be displayed in a web browser.        </Text>
      </View>
      ...
      {showQuizButton && (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('htmlQuizPage')}
        >
