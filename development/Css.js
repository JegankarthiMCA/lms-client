...
const localVideos = [
  {
    _id: '1',
    uri: require('../assets/videos/css.mp4'), 
  },
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.htmlInfoContainer}>
        <Text style={styles.htmlTitle}>Introduction to CSS</Text>
        <Text style={styles.htmlDescription}>
        Cascading Style Sheets is a style sheet language used for specifying the presentation and styling of a document written in a markup language such as HTML or XML.        </Text>
      </View>
      ...
      {showQuizButton && (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('CSSQuizPage')}
        >
