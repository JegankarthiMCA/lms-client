...
const localVideos = [
  {
    _id: '1',
    uri: require('../assets/videos/reactnative.mp4'),
  },
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.htmlInfoContainer}>
        <Text style={styles.htmlTitle}>Introduction to ReactNative</Text>
        <Text style={styles.htmlDescription}>
        JavaScript, often abbreviated as JS, is a programming language and core technology of the Web, alongside HTML and CSS.         </Text>
      </View>
      ...
      {showQuizButton && (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ReactNativeQuizPage')}
        >
