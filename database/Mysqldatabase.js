...
const localVideos = [
  {
    _id: '1',
    uri: require('../assets/videos/mysql.mp4'), 
  },
];

export default function Mysqldatabase() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.htmlInfoContainer}>
        <Text style={styles.htmlTitle}>Introduction to MYSQL</Text>
      ...
      {showQuizButton && (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MysqlQuizPage')}
        >
